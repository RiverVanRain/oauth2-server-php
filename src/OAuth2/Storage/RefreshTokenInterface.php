...
interface RefreshTokenInterface
{
     ...
     * @ingroup oauth2_section_6
     */
    public function setRefreshToken(string $refresh_token, string $client_id, int $user_id = 0, int $expires = 0, string $scope = null);
     ...
     * @ingroup oauth2_section_6
     */
    public function unsetRefreshToken(string $refresh_token);
}
